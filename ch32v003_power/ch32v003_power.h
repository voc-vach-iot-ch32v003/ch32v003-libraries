 ...
 * @author Vọc Vạch IoT
 * @brief Thư viện quản lý năng lượng thông minh cho CH32V003 (J4M6, A4M6,
 * F4P6).
 * @version 1.2
 * @date 2026-05-26
 */
...
/**
 * @brief Cấu hình một chân GPIO cụ thể làm chân Wakeup để đánh thức chip khi
 * ngủ sâu.
 ...
 * GPIOD0-7) mới có thể được cấu hình làm chân Wakeup. Việc chọn chân không hỗ
 * trợ sẽ không có tác dụng và có thể gây ra lỗi khi chạy vào chế độ ngủ sâu.
 ...
 *          Khi chân Wakeup phần cứng (PD0) nhận mức HIGH, chip sẽ tỉnh dậy và
 * RESET chạy lại từ đầu hàm main().
 */
